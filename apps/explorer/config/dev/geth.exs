  ...
  json_rpc_named_arguments: [
    ...
    transport_options: [
      ...
      method_to_url: [
        ...
        debug_traceTransaction: System.get_env("ETHEREUM_JSONRPC_TRACE_URL") || "http://0.0.0.0:12001",
        debug_traceBlockByNumber: System.get_env("ETHEREUM_JSONRPC_TRACE_URL") || "http://0.0.0.0:12001"
      ],
